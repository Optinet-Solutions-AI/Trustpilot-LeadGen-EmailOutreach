...
| `APIFY_YELP_ACTOR` | Cookieless Yelp listing+profile actor used by `YELP_LISTING_SOURCE=apify`. Measured 2026-08-12: $0.0365 for 10 businesses (~$3.65/1,000), returning rating, review count, phone (10/10), website (8/10), contact email (5/10), claimed status (10/10) | `memo23/yelp-scraper` |
